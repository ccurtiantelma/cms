...
export class CreateUserDto {
  ...
  @ApiPropertyOptional({
    description:
      "Guid dei ruoli personalizzati aggiuntivi: sostituisce l'insieme attuale. Richiede users:assign_roles; si possono aggiungere solo ruoli con permessi posseduti dal chiamante. Assente o vuoto: nessun ruolo aggiuntivo.",
    type: [String],
