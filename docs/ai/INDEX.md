...
| Auth, Ruoli & Permessi | `docs/ai/adr/ADR-99-rbac-dinamico-ruoli-e-permessi-granulari.md` · `docs/ai/specs/SPEC-RBAC-F1-schema-seed-cache-guard.md` · `docs/ai/plans/PLAN-RBAC-F1-schema-seed-cache-guard.md` · `docs/ai/specs/SPEC-RBAC-F2a-backend-api.md` · `docs/ai/plans/PLAN-RBAC-F2a-backend-api.md` · `docs/ai/adr/ADR-18-ownership-per-riga.md` · `docs/ai/adr/ADR-13-gestione-sessioni-dispositivi.md` · `docs/ai/adr/ADR-90-custom-fonts-code-e-role-manager.md` (§ 3, in discussione) · `app/backend/src/permissions/permissions.registry.ts` · `docs/business-rules.md` (A4 e § Permessi editoriali) |
